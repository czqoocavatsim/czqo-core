<div>
    ...
    <div wire:loading.remove>
        ...
        <p class="text-muted mb-1 mt-3" style="font-size: 1.1em;">Upcoming Training Sessions</p>
        @endif
        <div class="list-group z-depth-1 mt-3">
        ...
        @if (count($resultsOtsSessions) > 0)
        <p class="text-muted mb-1 mt-3" style="font-size: 1.1em;">Upcoming OTS Sessions</p>
        @endif
        <div class="list-group z-depth-1 mt-3">
            @foreach($resultsOtsSessions as $r)
