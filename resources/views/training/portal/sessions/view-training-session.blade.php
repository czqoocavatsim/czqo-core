...
<div class="d-flex flex-row align-items-center mt-3">
    ...
    <div>
        <h2 class="blue-text mt-2 mb-1 font-weight-bold">Training Session with {{$session->instructor->user->full_name}}</h2>
        <h5 class="fw-500">
...
<div class="row mt-3">
    <div class="col-md-6">
        ...
        @else
            <div class="list-group-item z-depth-1 rounded">
                <p>Not assigned by instructor.</p>
            </div>
        @endif
    </div>
    <div class="col-md-6">
...
<h3 class="font-weight-bold blue-text mb-3 mt-5">Remarks from instructor</h3>
{{$session->remarksHtml()}}
@endsection
