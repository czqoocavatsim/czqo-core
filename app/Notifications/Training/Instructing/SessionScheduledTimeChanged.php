...
class SessionScheduledTimeChanged extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->type == 'training') {
            return (new MailMessage())
                ...
                ->line("The scheduled time for your training session with {$this->session->instructor->user->full_name} has been changed to {$this->session->scheduled_time->toDayDateTimeString()}.")
            ...
            return (new MailMessage())
                ...
                ->line("The scheduled time for your OTS session with {$this->session->instructor->user->full_name} has been changed to {$this->session->scheduled_time->toDayDateTimeString()}.")
